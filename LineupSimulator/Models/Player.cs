...
namespace LineupSimulator.Models
{
    public class Player
    {
        ...
        public Player(FullPlayerEntryModel player)
        {
            this.UID = new Guid().ToString();
            this.Name = player.Name;
            this.Position = 1;
            this.ABs = player.AB;
            this.Walks = player.BB;
            this.Singles = (player.H - player.Double - player.Triple - player.HR);
            this.Doubles = player.Double;
            this.Triples = player.Triple;
            this.Homers = player.HR;
            this.Steals = player.SB;
            this.CaughtStealing = player.CS;
        }
